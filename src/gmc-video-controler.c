...
G_DEFINE_TYPE (GMCVideoControler,
	       gmc_video_controler,
	       CLUTTER_TYPE_GROUP);

#define GMC_VIDEO_CONTROLER_GET_PRIVATE(obj) \
(G_TYPE_INSTANCE_GET_PRIVATE ((obj), GMC_TYPE_VIDEO_CONTROLER, GMCVideoControlerPrivate))
